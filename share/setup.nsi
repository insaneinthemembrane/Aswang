...
!define URL http://www.Aswang.ru/

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/Aswang.ico"
...
#!define MUI_FINISHPAGE_RUN $INSTDIR\Aswang-qt.exe
...
OutFile Aswang-0.3.0-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    #File ../release/Aswang-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/Aswangd.exe
    ...
    #Delete /REBOOTOK $INSTDIR\Aswang.exe
...
Section /o -un.Main UNSEC0000
    #Delete /REBOOTOK $INSTDIR\Aswang-qt.exe
