...
const string strMessageMagic = "Aswang Signed Message:\n";
    ...
    if(pindexBest->nHeight+1 == 1)
        {
            ...
            else if(pindexBest->nHeight+1 >= 2 && pindexBest->nHeight+1 <= 4999)
        {
            nSubsidy = 100 * COIN;
        }
            else if(pindexBest->nHeight+1 >= 5000 && pindexBest->nHeight+1 <= 30100)
        {
            nSubsidy = 75 * COIN;
        }
            else if(pindexBest->nHeight+1 >= 30101 && pindexBest->nHeight+1 <= 999998)
        {
            nSubsidy = 1 * COIN;
        }
...
// Aswang: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Aswang", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Aswang";
        CTransaction txNew;
        txNew.nTime = 1518293196;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1518293196;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 511667 : 511667;
        ...
        assert(block.hashMerkleRoot == uint256("0xcdd3cf4e2ad45777443902db95b81791459e62e1868e82bda0bdbb2ce421a424"));
...
unsigned char pchMessageStart[4] = { 0xc1, 0xdb, 0xa2, 0xf1 };
